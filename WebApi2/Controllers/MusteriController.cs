...
namespace WebApi2.Controllers
{
    ...
    public class MusteriController : ControllerBase
    {
        ...
        [HttpGet("{customerId}")]
        public Musteri viewCustomerById(int customerId)
        {
            var dgr = _context.Musteris.Find(customerId);
            return dgr;
        }
        ...
        {
            //var viewCity = (from su in _context.SepetUruns
            //               join s in _context.Sepets on su.SepetId equals s.SepetId
            //               join m in _context.Musteris on s.MusteriId equals m.MusteriId
            //               where m.Sehir == city
            //               select new
